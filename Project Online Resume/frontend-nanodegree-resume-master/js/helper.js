...
var HTMLheaderRole = '<span>%data%</span><hr/><ul id="contacts" class="flex-box item"></ul>';
...
var HTMLlocation = '<span class="orange-text">location</span><span class="white-text">%data%</span><br><br>';

var HTMLbioPic = '<img src="%data%" class="biopic">';
var HTMLWelcomeMsg = '<span class="welcome-message">%data%</span>';

var HTMLskillsStart = '<h3 id="skillsH3">Skills at a Glance:</h3><ul id="skills" class="flex-box item"></ul>';
var HTMLskills = '<li class="flex-item"><span class="white-text">%data%</span></li>';

var HTMLtoolsStart = '<h3 id="skillsH3">Tools:</h3><ul id="tools" class="flex-box item"></ul>';
var HTMLtools = '<li class="flex-item"><span class="white-text">%data%</span></li>';
...
var HTMLonlineURL = '<br><a href="https://classroom.udacity.com/me">%data%</a>';
...
function initializeMap() {
  ...
  */
  function locationFinder() {
    ...
    // adds the single location property from bio to the locations array
   // locations.push(work.jobs.location);
